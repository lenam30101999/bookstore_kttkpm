...
use pttkht_btl;
CREATE TABLE Item (ItemID int(10) NOT NULL AUTO_INCREMENT, CartID int(10) NOT NULL, Name varchar(255), Quantity int(11), PRIMARY KEY (ItemID));
CREATE TABLE Cart (CartID int(10) NOT NULL AUTO_INCREMENT, OrderID int(10) NOT NULL, totalQuantity int(10) NOT NULL, PRIMARY KEY (CartID));
CREATE TABLE Payment (PayID int(10) NOT NULL AUTO_INCREMENT, ShipmentID int(10) NOT NULL, CartID int(10) NOT NULL, Price double NOT NULL, PRIMARY KEY (PayID));
...
CREATE TABLE `Order` (OrderID int(10) NOT NULL AUTO_INCREMENT, PaymentID int(10) NOT NULL, CustomerID int(10) NOT NULL, ShipmentID int(10) NOT NULL, `Date` date, Price double NOT NULL, PRIMARY KEY (OrderID));
CREATE TABLE Book (BookID int(10) NOT NULL AUTO_INCREMENT, ItemID int(10) NOT NULL, AuthorID int(10) NOT NULL, PublisherID int(10) NOT NULL, Name varchar(255), NumPage int(10) NOT NULL, Price double NOT NULL, PRIMARY KEY (BookID));
...
ALTER TABLE Book ADD CONSTRAINT FKBook743557 FOREIGN KEY (ItemID) REFERENCES Item (ItemID);
...
ALTER TABLE Cart ADD CONSTRAINT FKCart633249 FOREIGN KEY (OrderID) REFERENCES `Order` (OrderID);
